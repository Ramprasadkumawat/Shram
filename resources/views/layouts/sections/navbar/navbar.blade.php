                ...
                <a class="dropdown-item" href="javascript:void(0);">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      <span class="fw-medium d-block">{{ Auth::guard('admin')->user()->first_name ?? 'Admin' }} {{ Auth::guard('admin')->user()->last_name ?? 'User' }}</span>
                      <small class="text-muted">{{ ucfirst(Auth::guard('admin')->user()->type ?? 'Admin') }}</small>
                    </div>
                  </div>
                </a>
              </li>
